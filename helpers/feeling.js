module.exports = (response) => {
	...
	'angry':{'short-term':['Take deep breaths','stay positive','find someone to rant to', 'find funny things that will make you laugh'], 'long-term':['Talk to a therapist/professional', 'take anger management courses']},
